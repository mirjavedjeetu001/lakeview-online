<template>
    <AdminLayout active-menu="users" page-title="User Management">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-[760px]">
                        <thead class="bg-brand-50 border-b border-brand-100">
                            <tr><th class="table-head">User</th><th class="table-head">Phone</th><th class="table-head">Role</th><th class="table-head">Status</th><th class="table-head">Actions</th></tr>
                        </thead>
                        <tbody class="divide-y divide-brand-100">
                            ...
                            <tr v-if="!users.data?.length"><td colspan="5" class="p-12 text-center text-sm text-brand-500">No users found.</td></tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div v-if="showModal" class="fixed inset-0 z-[100] bg-brand-950/60 backdrop-blur-sm p-4 flex items-center justify-center" @click.self="showModal = false">
            <div class="w-full max-w-lg rounded-3xl bg-cream-50 shadow-2xl p-6 sm:p-8">
...
const blankForm = () => ({ name: '', phone: '', email: '', password: '', role: 'customer', is_active: true });
